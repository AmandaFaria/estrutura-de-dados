...
void     destruirLista2 (pDLista, FuncaoLiberacao);
...
/*
###############################################################################
# Questão 4 (2,0 pontos) – Escreva uma função RECURSIVA que encontra o maior  #
# elemento de uma lista encadeada.                                            #
# void* maiorElemento (pDLista lista, void* maiorAtual, FuncaoComparacao fc   #
###############################################################################
*/
void*    maiorElemento(pNoh, void*, FuncaoComparacao);
